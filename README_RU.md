...
- Хранилище SQLite, инициализируемое из `db/schema.sql` (базовая схема), с версионными миграциями, применяемыми программно при старте; ротируемые локальные логи и развёртывание через systemd.
