...
STRINGS: dict[str, str] = {
    ...
    "faq_connect": (
        ...
        "ключ All-in-One: одна ссылка-подписка сразу на все протоколы, клиент сам подтянет их все, "
        "и переключаться между ними можно прямо в приложении, без создания новых ключей."
    ),
    "faq_trouble": (
