...
STRINGS: dict[str, str] = {
    ...
    "faq_connect": (
        ...
        "или импортируйте файл, если он доступен. В зависимости от клиента и AWG-, и Xray-ключ можно "
        "добавить как по ссылке (профилю), так и через файл конфигурации. После импорта включите "
        ...
        "(например, AWG и Xray TCP/XHTTP). Если один из них начнёт деградировать из-за блокировок, "
        "вы переключитесь на другой и не останетесь без связи."
    ),
    "faq_trouble": (
