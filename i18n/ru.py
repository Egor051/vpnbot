...
STRINGS: dict[str, str] = {
    ...
    "faq_trouble": (
        ...
        "выбор транспорта предлагается при создании ключа.\n\n"
    ...
    "faq_device": (
        "Да. Один ключ рассчитан строго на одно устройство. При одновременном использовании одного и того же "
        "ключа на нескольких устройствах подключение гарантированно будет нестабильным: устройства мешают друг "
        "другу и постоянно отключаются, а статистика и управление доступом путаются."
    ),
    "faq_stats": (
    ...
    "faq_choice": (
        "<b>AWG (AmneziaWG)</b> — на базе WireGuard: проще и быстрее, ниже задержка. "
        "Хорош, когда VPN не блокируют.\n\n"
        "<b>Xray (VLESS + REALITY)</b> — маскирует трафик под обычный HTTPS, лучше обходит "
        "блокировки и DPI, но чуть сложнее и иногда чуть медленнее.\n\n"
        "Если не знаете, что выбрать, начните с Xray — он надёжнее работает при блокировках. "
        "Если важна максимальная скорость и блокировок нет — берите AWG."
    ),
    "faq_fingerprint": (
    ...
    "faq_security": (
        ...
        "VLESS+REALITY), и трафик нельзя прочитать со стороны.\n\n"
    ...
    "faq_support": (
        ...
        "• тип ключа (AWG или Xray) и его номер;\n"
