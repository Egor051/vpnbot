...
STRINGS: dict[str, str] = {
    ...
    "faq_connect": (
        ...
        "для Xray — v2RayTun или Happ (или аналоги, например v2RayNG, NekoBox); "
        "для Hysteria2 — NekoBox или Happ.\n\n"
        ...
        "блокировок, вы переключитесь на другой и не останетесь без связи."
    ),
    "faq_trouble": (
    ...
    "faq_device": (
        "Да. Один ключ рассчитан строго на одно устройство. При использовании одного и того же ключа на нескольких "
        "устройствах проблемы возникнут гарантированно: подключение будет работать нестабильно (устройства "
        "разрывают соединение друг у друга), а статистика и управление доступом будут путаться. "
        "Для каждого устройства создавайте отдельный ключ."
    ),
    "faq_stats": (
