...
STRINGS: dict[str, str] = {
    ...
    "faq_trouble": (
        ...
        "(кнопка «Изменить Fingerprint» в настройках ключа). Хорошие варианты для начала: Firefox или Chrome.\n\n"
    ...
    "faq_fingerprint": (
        ...
        "<b>Firefox</b> и <b>Chrome</b> — хороший выбор для большинства случаев.\n"
        "<b>Safari / iOS / Android / Edge / 360 / QQ</b> — альтернативы, если основные заблокированы.\n"
    ...
    "btn_fp_random": "Random — случайный из списка",
