...
STRINGS: dict[str, str] = {
    ...
    "faq_connect": (
        ...
        "для Xray — v2RayTun (или аналоги, например Hiddify, NekoBox); "
        "для Hysteria2 — NekoBox или Hiddify.\n\n"
    ...
    "faq_choice": (
        ...
        "<b>Hysteria2</b> — на базе QUIC/UDP с обфускацией трафика: держит высокую скорость на "
        "нестабильных и мобильных сетях (потери пакетов, высокий пинг) и помогает обходить блокировки. "
        "Нужен клиент с поддержкой Hysteria2 (NekoBox или Hiddify).\n\n"
