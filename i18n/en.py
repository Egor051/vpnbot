...
STRINGS: dict[str, str] = {
    ...
    "faq_choice": (
        "<b>Xray (VLESS + REALITY)</b> — the best at bypassing blocks and DPI, especially with "
        "the right config (transport and fingerprint) chosen. The trade-off is a connection that "
        "can be slower and have higher latency. A solid choice for everyday use.\n\n"
        "<b>AWG (AmneziaWG)</b> — based on WireGuard: gives minimal, stable latency. "
        "It's easy to block on some networks though, so it's best suited for gaming or calls "
        "on a home connection with no blocking.\n\n"
        "<b>Hysteria2</b> — runs on the same transport as AWG, so it delivers the same low "
        "latency, but disguises itself better as regular web traffic and holds up better on "
        "unstable networks — which also means higher speed in those conditions. On some "
        "networks it can still fall short of Xray.\n\n"
        "If you're not sure what to choose, start with Xray — it's more reliable under blocking. "
        "If minimal latency matters and there's no blocking, go with AWG. "
    ...
    "note_too_long": "The note is too long (maximum {max} characters). Shorten it and try again.",
    # ── access gate (blocked user) ────────────────────────────────────────────
    "blocked_message": "🚫 Bot access is blocked. Send /start to request access again.",
    "blocked_callback": "🚫 Access blocked. Send /start to request access again.",
    # ── service-layer error messages (P7-003) ─────────────────────────────────
    "err_user_not_found": "User not found",
    "err_key_not_found": "Key not found",
    "err_insufficient_rights": "Insufficient permissions",
    "err_access_blocked": "Access blocked",
    "err_foreign_keys_view": "You cannot view other users' keys",
    "err_foreign_key_view": "You cannot view another user's key",
    "err_foreign_key_manage": "You cannot manage another user's key",
    "err_foreign_stats_view": "You cannot view another user's key statistics",
    "err_note_own_only": "You can only edit notes on your own keys",
    "err_create_for_other": "You cannot create keys for another user",
    "err_guest_admin_only": "Only an administrator can issue keys to guests",
    "err_issue_to_blocked": "You cannot issue a key to a blocked user",
    "err_owner_no_access": "The key owner has no access",
    "err_not_xray_key": "This is not an Xray key",
    "err_not_awg_key": "This is not an AWG key",
    "err_not_hy2_key": "This is not a Hysteria2 key",
    "err_config_active_only": "The configuration is available only for an active key",
    "err_revoke_active_xray_only": "Only an active Xray key can be revoked",
    "err_revoke_active_awg_only": "Only an active AWG key can be revoked",
    "err_revoke_active_hy2_only": "Only an active Hysteria2 key can be revoked",
    "err_fp_active_only": "The fingerprint can be changed only for an active key",
    "err_fp_unsupported": "Unsupported fingerprint",
    "err_hy2_disabled": "Hysteria2 is currently disabled",
    "err_vless_http_disabled": "VLESS (HTTP) is currently disabled",
    "err_xhttp_not_configured": "VLESS (HTTP) transport is unavailable: the XHTTP inbound is not configured",
    "err_subscription_disabled": "The all-in-one subscription is currently disabled",
    "err_bundle_not_found": "Subscription not found",
    "err_bundle_no_backends": "No enabled protocols for an all-in-one subscription",
    ...
    "err_trial_owner_not_found": "The owner user was not found",
    "err_create_proxy_for_other": "You cannot create a proxy for another user",
    "err_proxy_owner_no_access": "The proxy owner has no access",
    "err_proxy_not_found": "Proxy not found",
    "err_socks5_access_not_found": "SOCKS5 access not found",
    "err_mtproto_access_not_found": "MTProto access not found",
    "err_proxy_access_not_found": "Proxy access not found",
    "err_not_socks5_access": "This is not SOCKS5 access",
    "err_not_mtproto_access": "This is not MTProto access",
    "err_socks5_unavailable": "SOCKS5 is currently unavailable",
    "err_socks5_not_configured": "SOCKS5 is not configured",
    "err_mtproto_unavailable": "MTProto Proxy is currently unavailable",
    "err_mtproto_not_configured": "MTProto Proxy is not configured",
}
