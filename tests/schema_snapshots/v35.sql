-- Schema snapshot: version 35. GENERATED by scripts/dump_schema_snapshot.py —
-- do not hand-edit. Replayed by tests/test_schema_upgrade_path.py, which loads this
-- file into an empty database, stamps schema_version=35 and runs bootstrap()
...
CREATE TABLE warp_split_baseline (
...
CREATE TABLE warp_split_pending (
