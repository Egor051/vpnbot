-- Schema snapshot: version 32. GENERATED by scripts/dump_schema_snapshot.py —
-- do not hand-edit. Replayed by tests/test_schema_upgrade_path.py, which loads this
-- file into an empty database, stamps schema_version=32 and runs bootstrap()
...
CREATE INDEX idx_access_requests_pending_created ON access_requests(status, requested_at);
...
CREATE INDEX idx_vpn_keys_status_type ON vpn_keys(status, key_type);
