...
| `WARP_SPLIT_FEED_ALERT_DELTA_PCT` | `30` | An **automatic** refresh applies itself, but notifies admins when the list changes by more than this percentage. Manual refreshes always show a delta preview and ask for confirmation regardless. |
